...
const Navbar = () => {
  ...
  return (
    <div className="relative">
      <div className="hidden sm:block bg-gradient-to-r from-blue-400 from-10% via-blue-400 via-30% to-blue-500 to-90%">
        <div className="flex flex-row justify-start items-center w-full sm:w-[480px] md:w-[640px] lg:w-[960px] xl:w-[1100px] h-[100px] m-auto">
